...
const CATEGORIES: CategorySeed[] = [
  // ── 1. Grocery ────────────────────────────────────────────────────────────────
  {
    ...
    attributeSchema: [
      ...
      { key: 'quantity_per_pack', label: 'Quantity per Pack',  type: 'number',      required: false, unit: 'pcs' },
  ...
  // ── 2. Restaurant & Food ──────────────────────────────────────────────────────
  {
    ...
    attributeSchema: [
      ...
      { key: 'portion',      label: 'Portion / Weight', type: 'text',      required: false, unit: 'g / ml' },
    ...
    attributeSchema: [
      ...
      { key: 'color',        label: 'Color',            type: 'color',       required: false,
        options: [
          ...
          { label: 'Space Grey', value: 'space_grey', hex: '#374151' },
          { label: 'Rose Gold',  value: 'rose_gold',  hex: '#FBCFE8' },
    ...
    attributeSchema: [
      ...
      { key: 'colors',      label: 'Available Colors',   type: 'color',       required: false,
        options: [
          ...
          { label: 'Navy',    value: 'navy',    hex: '#1E3A5F' }, { label: 'Green',   value: 'green',   hex: '#22C55E' },
          { label: 'Olive',   value: 'olive',   hex: '#6B7C43' }, { label: 'Yellow',  value: 'yellow',  hex: '#EAB308' },
          { label: 'Pink',    value: 'pink',    hex: '#EC4899' }, { label: 'Maroon',  value: 'maroon',  hex: '#7F1D1D' },
          { label: 'Beige',   value: 'beige',   hex: '#D2B48C' }, { label: 'Brown',   value: 'brown',   hex: '#92400E' },
          { label: 'Grey',    value: 'grey',    hex: '#6B7280' }, { label: 'Orange',  value: 'orange',  hex: '#F97316' },
          { label: 'Purple',  value: 'purple',  hex: '#A855F7' }, { label: 'Cream',   value: 'cream',   hex: '#FFFDD0' },
        ] },
  ...
  // ── 5. Pharmacy & Medicine ────────────────────────────────────────────────────
  {
    ...
    attributeSchema: [
      ...
      { key: 'form',          label: 'Form',                  type: 'select',   required: true,
        options: [
      ...
      { key: 'pack_size',     label: 'Pack Size',             type: 'number',   required: false, unit: 'units' },
  ...
  // ── 6. Beauty & Personal Care ─────────────────────────────────────────────────
  {
    ...
    attributeSchema: [
      ...
      { key: 'shade',            label: 'Shade / Color',       type: 'color',       required: false,
        options: [
          { label: 'Nude',    value: 'nude',    hex: '#D4A088' }, { label: 'Coral',   value: 'coral',   hex: '#FF7F50' },
          { label: 'Red',     value: 'red',     hex: '#CC0000' }, { label: 'Pink',    value: 'pink',    hex: '#FF69B4' },
          { label: 'Mauve',   value: 'mauve',   hex: '#E0B0FF' }, { label: 'Berry',   value: 'berry',   hex: '#8B0057' },
          { label: 'Brown',   value: 'brown',   hex: '#7B3F00' }, { label: 'Peach',   value: 'peach',   hex: '#FFDAB9' },
          { label: 'Beige',   value: 'beige',   hex: '#D2B48C' }, { label: 'Clear',   value: 'clear',   hex: '#F5F5F5' },
        ] },
  ...
  // ── 7. Home & Kitchen ─────────────────────────────────────────────────────────
  {
    ...
    attributeSchema: [
      ...
      { key: 'color',             label: 'Color / Finish',      type: 'color',       required: false,
        options: [
          { label: 'Black',    value: 'black',    hex: '#111827' }, { label: 'White',    value: 'white',    hex: '#F9FAFB' },
          { label: 'Silver',   value: 'silver',   hex: '#9CA3AF' }, { label: 'Gold',     value: 'gold',     hex: '#D97706' },
          { label: 'Brown',    value: 'brown',    hex: '#92400E' }, { label: 'Beige',    value: 'beige',    hex: '#D2B48C' },
      ...
      { key: 'capacity',          label: 'Capacity / Quantity', type: 'text',        required: false, unit: 'L / pcs' },
    ...
    attributeSchema: [
      ...
      { key: 'color',        label: 'Color',          type: 'color',       required: false,
        options: [
          ...
          { label: 'Orange', value: 'orange', hex: '#F97316' }, { label: 'Grey',   value: 'grey',   hex: '#6B7280' },
  ...
  // ── 10. Furniture & Decor (new) ───────────────────────────────────────────────
  {
    ...
    attributeSchema: [
      ...
      { key: 'color',             label: 'Color / Finish',      type: 'color',       required: false,
        options: [
          { label: 'Natural Wood', value: 'natural_wood', hex: '#C19A6B' }, { label: 'Walnut',      value: 'walnut',  hex: '#5C3D1E' },
          { label: 'White',        value: 'white',        hex: '#FFFFFF' }, { label: 'Black',       value: 'black',   hex: '#111827' },
          { label: 'Grey',         value: 'grey',         hex: '#6B7280' }, { label: 'Brown',       value: 'brown',   hex: '#78350F' },
          { label: 'Beige / Cream',value: 'beige',        hex: '#D2B48C' }, { label: 'Gold',        value: 'gold',    hex: '#D97706' },
          { label: 'Matte Black',  value: 'matte_black',  hex: '#1F2937' },
        ] },
  ...
  // ── 13. Jewellery & Accessories (new) ─────────────────────────────────────────
  {
    ...
    attributeSchema: [
      ...
      { key: 'color',      label: 'Color / Finish',  type: 'color',      required: false,
        options: [
          { label: 'Gold',      value: 'gold',      hex: '#D97706' }, { label: 'Rose Gold',  value: 'rose_gold',  hex: '#FBCFE8' },
          { label: 'Silver',    value: 'silver',    hex: '#9CA3AF' }, { label: 'Gunmetal',   value: 'gunmetal',   hex: '#4B5563' },
          { label: 'Black',     value: 'black',     hex: '#111827' }, { label: 'White/Pearl',value: 'white',      hex: '#F9FAFB' },
          { label: 'Multi',     value: 'multi',     hex: '#8B5CF6' }, { label: 'Oxidised',   value: 'oxidised',   hex: '#374151' },
  ...
  // ── 14. Pet Supplies (new) ────────────────────────────────────────────────────
  {
    ...
    attributeSchema: [
      ...
      { key: 'weight',        label: 'Weight / Volume',   type: 'text',     required: false, unit: 'g / ml' },
      { key: 'flavor',        label: 'Flavor / Variant',  type: 'text',     required: false },
  ...
  // ── 15. Baby & Kids (new) ─────────────────────────────────────────────────────
  {
    ...
    attributeSchema: [
      ...
      { key: 'color',            label: 'Color',             type: 'color',       required: false,
        options: [
          { label: 'White',  value: 'white',  hex: '#F9FAFB' }, { label: 'Pink',   value: 'pink',   hex: '#FBCFE8' },
          { label: 'Blue',   value: 'blue',   hex: '#BFDBFE' }, { label: 'Yellow', value: 'yellow', hex: '#FDE68A' },
          { label: 'Green',  value: 'green',  hex: '#A7F3D0' }, { label: 'Red',    value: 'red',    hex: '#FCA5A5' },
